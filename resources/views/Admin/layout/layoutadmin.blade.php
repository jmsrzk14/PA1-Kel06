  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
            @if (Auth::user()->foto)
                <img src="{{ asset('admin/foto/' . Auth::user()->foto) }}" class="img-circle elevation-2" x alt="User Image" style="aspect-ratio: 1/1;">
            @else
                <img src="{{ asset('admin/dist/img/avatar.jpg') }}" class="img-circle elevation-2" alt="User Image">
            @endif
        </div>
        <div class="info">
          <a href="/admin/dashboard" class="d-block" style="font-size: 14px">{{ Auth::user()->name }}</a>
        </div>
      </div>
