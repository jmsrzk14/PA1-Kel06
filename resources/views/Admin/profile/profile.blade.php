            ...
            <ul class="navbar-nav ml-auto float-right">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item text-dark" href="{{ url('/admin/update-admin-details') }}">Update Data</a>
                    </div>
                </li>
            </ul>
        </div>
            ...
            <div id="grid-system2" class="col-sm-3">
                <div class="box box-solid ">
                    <div id="grid-system2-body" class="box-body">
                        <img src="{{ asset('admin/foto/' . Auth::user()->foto) }}" class="img-thumbnail" width="500">
                    </div>
                </div>
            </div>
            <a href="/admin/dashboard" class="btn btn-info btn-sm mt-5 mr-5 mb-2">Kembali</a>
        </div>
    </div>
</div>
@endsection
