        ...
        <form class="forms-sample" action="{{ url('kasir/update-kasir-details') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="container mt-3">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="noTelp" class="form-control" name="noTelp" value="{{ Auth::user()->noTelp }}" placeholder="No Telepon" maxlength="12" minlength="11">
                        <p class="help-block help-block-error "></p>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    @if (!empty(Auth::user()->foto))
                        <a class="btn btn-info bg-primary btn-sm" target="_blank"
                            href="{{ URL::asset('kasir/foto/' . Auth::user()->foto) }}">View
                            Gambar</a>
